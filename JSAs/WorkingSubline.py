...
JobActivity = "Working with Subline"
Pagevar = "1"
ofvar = "1"
tday = datetime.now()
...
Ph4.send_keys(pinch, slip, burst)

Ph5 = driver.find_element(By.XPATH, '//*[@id="field114239224"]' )
Ph5.send_keys(pinch, slip)
...
Mb4.send_keys (ppe, situ, proc)

Mb5 = driver.find_element(By.XPATH, '//*[@id="field114239222"]')
Mb5.send_keys (ppe, situ, proc)
